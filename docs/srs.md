...
- **FR-1 Регистрация и роли**
    ...
    - Администратор должен иметь возможность просматривать запросы, утверждать или отклонять их и регистрировать
      пользователя с указанной ролью.
...
- локальный индекс (кэш извлеченного текста) должен храниться в отдельной директории и может быть восстановлен путем
